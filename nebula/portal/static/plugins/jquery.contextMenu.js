                    ...
                    if (typeof item == "string") {
                        ...
                        switch (item.type) {
                            case 'sub':
                                ...
                                var sub_indicator = opt.sub_indicator || item.sub_indicator;
                                if (typeof sub_indicator === 'string') {
                                    $(sub_indicator).addClass('context-menu-submenu-indicator').appendTo($t);
                                }
                        ...
                        // add icons
                        var $icon = $('<i class="context-menu-item-icon"></i>').prependTo($t);
                        if (item.icon) {
                            $icon.addClass('fa').addClass('fa-' + item.icon);
                        }
                    }
    ...
    $.contextMenu = function(operation, options) {
        ...
        switch (operation) {
            case 'create':
                ...
                if (o.selector.match(/.context-menu-(list|item)($|\s)/)) {
