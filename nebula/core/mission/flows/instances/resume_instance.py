...
class ResumeOSInstanceTask(task.NebulaTask):
    def __init__(self):
        super(ResumeOSInstanceTask, self).__init__(addons=[ACTION])
...
def get_flow():
    ...
    flow.add(ResumeOSInstanceTask())
    return flow


class InstanceResumeBuilder(InstanceURDBuilder):
    def __init__(self, context, resource_kwargs=None, store=None):
        super(InstanceResumeBuilder, self).__init__(
            context,
